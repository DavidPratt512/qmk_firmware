...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ctrl | alt  | gui  | home |  NUM |  FUN | space|  NAV | end  | vol+ | alt  | ctrl |
     * `-----------------------------------------------------------------------------------'
     */
    [_QWERTY] = LAYOUT_planck_grid(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI, KC_HOME, MO(_NUM), MO(_FUN), KC_SPC, MO(_NAV), KC_END,  KC_VOLU, KC_LALT, RCTL_T(KC_CAPS)
    ),
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ctrl | alt  | gui  | home | MO(1)| MO(3)| space| MO(2)| end  | vol+ | alt  | ctrl |
     * `-----------------------------------------------------------------------------------'
     */
    ...
    [_NUM] = LAYOUT_planck_grid(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0, KC_TRNS, KC_VOLD, KC_TRNS, KC_TRNS
    ),
    ...
    [_NAV] = LAYOUT_planck_grid(
        ...
        KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_TRNS, KC_TRNS
    ),
    ...
    [_FUN] = LAYOUT_planck_grid(
        ...
        KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12,  A(KC_9),    MO(_MISC),     A(KC_END),   KC_LT,   KC_GT,   KC_BSLS, KC_TRNS,
...
bool get_hold_on_other_key_press(uint16_t keycode, keyrecord_t *record) {
    /*
     * Return false for a keycode as to *not* select the hold action on other keypress.
